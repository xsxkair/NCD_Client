...
public class ManagerHandler {
	...
	public void UI_Init(){
		...
		loader.setLocation(this.getClass().getResource("/com/xsx/ncd/views/ManagerPage.fxml"));
        InputStream in = this.getClass().getResourceAsStream("/com/xsx/ncd/views/ManagerPage.fxml");
        ...
        acceptButton0.setOnMouseClicked((e)->{
			...
			if(admin.getPassword().equals(adminPasswordTextField.getText())){
				...
				if((userAccountTextField1.getText() == null) || (userPasswordTextField1.getText() == null)
					...
					tempUser.setFatheraccount(null);
	...
	private void upUserList() {
		...
		managerrListView.getItems().addAll(userRepository.queryAllManager());
