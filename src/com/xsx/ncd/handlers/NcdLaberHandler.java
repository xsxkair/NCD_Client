...
public class NcdLaberHandler {
	...
	public void UI_Init(){
		...
		loader.setLocation(this.getClass().getResource("/com/xsx/ncd/views/NcdLaberPage.fxml"));
        InputStream in = this.getClass().getResourceAsStream("/com/xsx/ncd/views/NcdLaberPage.fxml");
	...
	private void upUserList() {
		...
		managerrListView.getItems().addAll(userRepository.queryAllNcdLaber());
