...
public class WorkSpaceHandler {
	...
	public void UI_Init() {
		...
		loader.setLocation(this.getClass().getResource("/com/xsx/ncd/views/WorkSpacePage.fxml"));
		InputStream in = this.getClass().getResourceAsStream("/com/xsx/ncd/views/WorkSpacePage.fxml");
