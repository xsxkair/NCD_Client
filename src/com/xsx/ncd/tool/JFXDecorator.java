...
public class JFXDecorator extends VBox {
	...
	public JFXDecorator(Stage stage, Node node, boolean fullScreen, boolean max, boolean min) {
		...
		this.setStyle("-fx-background-color :  #10518c");
		...
		btnFull.setStyle("-fx-border-color: linear-gradient(to bottom , #0a2e63, #00000000)");
		...
		btnClose.setStyle("-fx-border-color: linear-gradient(to bottom , #0a2e63, #00000000)");
		...
		btnMin.setStyle("-fx-border-color: linear-gradient(to bottom , #0a2e63, #00000000)");
		...
		btnMax.setStyle("-fx-border-color: linear-gradient(to bottom , #0a2e63, #00000000)");
		...
		for (JFXButton jfxButton : btns) {
			jfxButton.setOnMouseEntered((e)->{
				SVGGlyph temp = (SVGGlyph) jfxButton.getGraphic();
		...
		contentPlaceHolder.setBorder(new Border(new BorderStroke(Color.web("0x10518c"), BorderStrokeStyle.SOLID, CornerRadii.EMPTY, new BorderWidths(0, 4, 4, 4))));
		// BINDING
